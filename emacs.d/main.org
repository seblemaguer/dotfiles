...
#+begin_src emacs-lisp
  (use-package eaf
    :ensure straight
    :tags '("HELPER")
    :load-path "~/environment/src/emacs/emacs-application-framework")
#+end_src
* Editor
...
#+begin_src emacs-lisp
  (use-package om
    :straight (om :type git :host github :repo "ndwarshuis/om.el"))
  ...
  (use-package metal-archives
    ...
    :custom
    (metal-archives-shopping-list-target-file "~/.emacs.d/shopping_list.org")
