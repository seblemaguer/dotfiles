...
#+begin_src emacs-lisp :tangle yes
  (use-package paradox
    ...
    (setq paradox-spinner-type 'progress-bar
          ...
          paradox-github-token (my:auth-source-get-passwd :host "github.cm" :user "seblemaguer^paradox")))
#+end_src
...
#+begin_src emacs-lisp :tangle yes
  (use-package anki-editor
    :ensure t
    :init
    (defhydra anki-editor-hydra (:color teal)
      "Anki editor"
...
#+begin_src emacs-lisp :tangle yes
  (use-package dired
    ...
    (define-key dired-mode-map (kbd "p") 'dired-emms-play)
