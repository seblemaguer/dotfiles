  ...
  (use-package org-agenda
    ...
    (defun color-org-header (tag backcolor)
      ...
      (while (re-search-forward tag nil t)
        (add-text-properties (match-beginning 0) (+ (line-end-position) 1)
                             `(face (:background, backcolor)))))

    :hook
    (org-agenda-finalize . (lambda ()
                             (save-excursion
                               (color-org-header "me_and_myself:" "ivory")
                               (color-org-header "adapat_events:" "PaleGreen1")
                               (color-org-header "Release:" "RosyBrown1"))))
    :hydra
    ...
    (when (file-exists-p "~/Calendars")
      (add-to-list 'org-agenda-files (directory-files "~/Calendars/" t "^.*\\.org$")))
    ...
    (setq org-capture-templates
          `(("b" "Adding book" entry
            ...
            ("P" "Personnal calendar" entry
             (file "~/Calendars/me_and_myself.org")
