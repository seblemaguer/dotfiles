...
#+BEGIN_SRC emacs-lisp :tangle ~/.emacs.d/init.el
  (defun slm~tangle-byte-compile-org ()
    ...
    (when (equal (buffer-name)
      ...
      ;; Delete to force
      (when (file-exists-p (format "%s/init.elc" user-emacs-directory))
        (delete-file (format "%s/init.elc" user-emacs-directory)))

      ;; Recompile file !
      (byte-compile-file (format "%s/init.el" user-emacs-directory))))
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
  (use-package yasnippet
    ...
    (defvar third-parties-snippet-dir (format "%s/third_parties/snippets" config-basedir)
  ...
  (use-package org-agenda
    ...
    (setq org-agenda-include-diary nil
          ...
          `(
            ...
            ("\\([Pp]apers?\\|[Bb]lio\\|[Aa]rticles?\\|[Rr]eading\\|[Ww]riting\\)" ,(format "%s/third_parties/icons/book.png" config-basedir) nil nil :ascent center)
    ...
    (setq org-capture-templates
          `(("b" "Adding book" entry
            ...
            ("f" "Reference" entry
             ...
             (file ,(format "%s/third_parties/org-capture-templates/reference.org" config-basedir)))
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
  (use-package anki-editor
    ...
    :bind
    (:map anki-editor-map ("C-x v" . anki-editor-hydra/body))
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
  ...
  (defun notmuch-save-attachments (mm-handle dir)
  ...
  (defun notmuch-mm-save-part (handle dir)
...
#+begin_src emacs-lisp :tangle ~/.emacs.d/init.el
  (use-package md4rd
    ...
    (md4rd-hydra (:color blue :hint none)
                 "
        _(or )_: open   _u_: upvote       _e_: expand all     _t_: toggle line
