...
#+begin_src emacs-lisp
  (use-package sauron-mode-line
    ...
    :hook (after-init . sauron-start-hidden)
    :custom (sauron-event-added-functions 'sauron-mode-line-notifier-from-sauron)
    :bind
...
#+begin_src emacs-lisp
  (use-package erc
    ...
    (erc-autojoin-channels-alist '(
                                   ("freenode.net" "#emacs" "#latex" "#org-mode" "#python")
                                   ("gitter.im"
...
#+begin_src emacs-lisp
  (use-package elfeed
    ...
    :commands (elfeed elfeed-update-background-start)
    :no-require t
    :bind (([f9] . elfeed))
