...
*** Main Helper
#+begin_src emacs-lisp
  (defhydra main-hydra (:color teal :hint nil)
    "
    Main helper
...
#+begin_src emacs-lisp
  (defhydra project-hydra (:color teal :hint nil)
    "
...
#+begin_src emacs-lisp
  (use-package remind-bindings
    ...
    :bind (("C-h C-d" . 'remind-bindings-togglebuffer)   ;; toggle buffer
...
#+begin_src emacs-lisp
  (use-package dired
    ...
    :hydra
    (dired-hydra (:hint nil :color pink)
                 "
...
#+begin_src emacs-lisp
  (use-package magit
    ...
    :hydra
    (magit-hydra (:color teal :hint nil)
...
#+begin_src emacs-lisp
  (use-package counsel-projectile
    ...
    :hydra
    (projectile-hydra (:color teal :hint nil)
                      "
...
#+begin_src emacs-lisp
  ...
  (use-package flycheck
    ...
    :hydra
    (flycheck-hydra (:pre (progn (setq hydra-hint-display-type t) (flycheck-list-errors))
...
#+begin_src emacs-lisp
  (use-package groovy-mode
    ...
    (setq lsp-groovy-server-file "~/environment/local/lib/groovy-language-server.jar"))
...
**** Global
  #+begin_src emacs-lisp
    (use-package pdf-tools
      ...
      :hydra
      (pdftools-hydra (:color blue :hint nil)
                      "
                PDF tools
...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    :hydra
    (mu4e-headers-hydra (:color blue :hint nil)
                        "
...
#+begin_src emacs-lisp
  (use-package org-agenda
    ...
    :hydra
    (org-agenda-view-hydra (:color blue :hint none)
                           "
