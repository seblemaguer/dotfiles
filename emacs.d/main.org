...
#+begin_src emacs-lisp
  (use-package elfeed-dashboard
    ...
    :config
    (setq elfeed-dashboard-file "~/.emacs.d/third_parties/dashboards/elfeed.org")
...
**** DONE Notification activation
CLOSED: [2021-01-05 Tue 09:18]
Concerning the notification, =sauron= already supports ERC via the package =sauron-erc=.
I simply redefined the priorities to be more in phase with how I use it.
...
#+begin_src emacs-lisp
  (use-package metal-archives-shopping-list
    ...
    :custom
    (metal-archives-shopping-list-target-file (format "%s/perso/music/shopping_list.org" cloud-org-root-dir))
