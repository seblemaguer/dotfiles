...
#+begin_src emacs-lisp
  (use-package overleaf
    ...
    :custom
    (overleaf-use-nerdfont nil "Use nerfont icons for the modeline.")
    ...
    (setq overleaf-cookies
          `((".overleaf.com"
             ,(format "overleaf_session2=%S" (keepass-get-password keepass-db "overleaf-api"))
             ,(string-to-number (keepass-get-attribute keepass-db "overleaf-api" "expiry_time")))))
