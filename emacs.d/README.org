...
#+begin_src emacs-lisp
  ...
  (use-package auto-dim-other-buffers
    ...
    :custom-face
    (auto-dim-other-buffers-hide ((((background light)) :foreground "#dbe4f1" :background "#dbe4f1")
                                  (t                    :foreground "#ecf0f1" :background "#ecf0f1")))
    (auto-dim-other-buffers      ((((background light)) :background "#dbe4f1")
                                  (t                    :background "#ecf0f1")))
    :config
