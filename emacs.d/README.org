    ...
    (setq org-super-agenda-groups
          '(
            ...
            (:name "Ordered Releases"
                   :and (:category "RELEASE" :todo "ORDERED")
                   :order 9)
...
#+begin_src emacs-lisp
  (use-package slack
    :ensure (:protocol ssh :type git :host github :repo "seblemaguer/emacs-slack")
...
:PROPERTIES:
:ID:       6ce884e5-85df-4a93-8fdf-72781a15c550
:END:
