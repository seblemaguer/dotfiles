...
:END:
*** DONE sqlite
CLOSED: [2026-02-12 Thu 09:27]
:PROPERTIES:
:ID:       dd56564e-94a8-4e05-8861-637ed924cc73
:END:
The main database format I am using for now is sqlite.
=elsqlite= is a neat project which provides a nice way of inspecting it.

#+BEGIN_SRC emacs-lisp
  (use-package elsqlite
    :tags '("PROGRAMMING" "DATABASES")
    :bind (:map elsqlite-table-mode-map (
        ("M-u" . elsqlite-table-back-to-schema)
     ))
    :config
