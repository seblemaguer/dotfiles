...
#+begin_src emacs-lisp
  (use-package org-mru-clock
    ...
    (define-advice org-clock-in (after sacha activate)
...
#+begin_src emacs-lisp
  (use-builtin org-archive
    ...
    (define-advice org-archive-subtree (around fix-hierarchy activate)
...
#+begin_src emacs-lisp
  (use-builtin project
   ...
   ;; NOTE: required to ensure version consistency with eglot
