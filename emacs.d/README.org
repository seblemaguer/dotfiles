...
The process of how to deal with the packages is the following:
  ...
  - if the package is not on melpa, let's use =elpaca=
  - if the package is on melpa but requires extra development, let's use =elpaca=
...
#+begin_src emacs-lisp
  (use-package use-package-tags
    :elpaca (use-package-tags :host github :repo "seblemaguer/use-package-tags")
    :config
...
While alternatives exist, I find this combination more elpacaforward and cleaner when it is used in combination with =use-package=.
...
#+begin_src emacs-lisp
  (elpaca-wait) ;; NOTE: needed because sauron-mode-line requires sauron to be available
...
#+begin_src emacs-lisp
  (use-package bufler
    ...
    (bufler-groups (bufler-defgroups
		     ...
		     ;; NOTE: should depends on projectile if it is installed!
...
#+begin_src emacs-lisp
  ...
  (use-package goto-last-point
    ...
    :elpaca (goto-last-point :host github
                             :repo "emacsmirror/goto-last-point")
    :tags '("CORE" "NAVIGATION")
...
** TODO Reload file at saved position
:PROPERTIES:
  ...
  (use-package ob
    ...
    (org-babel-do-load-languages 'org-babel-load-languages
				 '((emacs-lisp . t)
				   ...
				   (clojure    . t)
				   (shell      . t)
				   ;; FIXME: doesn't seem to activate (ledger     . t)
				   (org        . t)
				   (plantuml   . t)
				   (latex      . t)
...
#+begin_src emacs-lisp
  (use-package org-unique-id
    :after org
    :elpaca (org-unique-id :host github
...
#+BEGIN_SRC emacs-lisp
  (use-package org-menu
    :elpaca (org-menu :host github :repo "sheijk/org-menu")
    :tags '("ORG")
    :bind (:map org-mode-map (
...
#+begin_src emacs-lisp
  (use-package org-super-agenda
    :elpaca (org-super-agenda :host github
...
#+begin_src emacs-lisp
  (use-package org-web-tools
    ...
    :tags '("ORG" "CAPTURE" "DESKTOP" "CONNECTED"))
#+end_src
* TODO Notes taking & academic organizing [66%]
...
#+begin_src emacs-lisp
  ...
  (use-package org-roam-protocol
    :elpaca (org-roam-protocol :host github :repo "org-roam/org-roam" :files ("extensions/org-roam-protocol.el"))
    :tags '("ORG" "USER")
    :after org-roam
    :config
...
#+begin_src emacs-lisp
  (use-package pdf-tools
    :elpaca (pdf-toos :host github :repo "vedang/pdf-tools")
...
#+begin_src emacs-lisp :lexical no
  ...
  (use-package org-media-noter
    :elpaca (org-media-noter :host github :repo "seblemaguer/org-media-noter")
    :tags '("BIBLIOGRAPHY" "USER" "ORG" "DESKTOP")
...
#+begin_src emacs-lisp
  ...
  (use-package company-box
    :after company
    :tags '("COMPLETION" "UI")
    :elpaca (company-box :repo "seblemaguer/company-box" :host github :branch "functional")
...
#+begin_src emacs-lisp
  ...
  (use-package yasnippet-snippets
    :tags '("COMPLETION")
    :elpaca (consult-yasnippet :host github
...
#+begin_src emacs-lisp
  (use-package compile
    :elpaca nil ;; NOTE: this package is part of the core emacs!
...
#+begin_src emacs-lisp
  (use-package cue-mode
    :elpaca (cue-mode :repo "seblemaguer/cue-mode" :host github)
...
#+begin_src emacs-lisp
  (use-package colored-authinfo-mode
    :elpaca (colored-authinfo-mode :repo "seblemaguer/colored-authinfo-mode" :host github)
    :tags '("PROGRAMMING" "CONFIGURATION")
...
#+begin_src emacs-lisp
  (when (executable-find "latexmk")
    (use-package auctex-latexmk
      :elpaca (auctex-latexmk :host github :repo "wang1zhen/auctex-latexmk")
...
#+begin_src emacs-lisp
  (use-package emacs-overleaf
    ...
    :elpaca (emacs-overleaf :host github :repo "seblemaguer/emacs-overleaf")
...
#+begin_src emacs-lisp
  (use-package tikz-mode
    :elpaca (tikz-mode :host github :repo "seblemaguer/tikz-mode")
...
#+begin_src emacs-lisp
  ...
  (use-package mw-thesaurus
    :elpaca (mw-thesaurus :fetcher github :repo "agzam/mw-thesaurus.el")
    :tags '("WRITING" "HELPERS" "CONNECTED")
...
#+begin_src emacs-lisp
  (use-package wordreference
    :elpaca (wordreference :host github :repo "emacsmirror/wordreference")
...
#+begin_src emacs-lisp
  ...
  (use-package gh-notify
    :elpaca (gh-notify :host github :repo "anticomputer/gh-notify"))
...
#+begin_src emacs-lisp :lexical no
    (use-package file-info
      ...
      :elpaca (file-info :host github :repo "artawower/file-info.el")
...
#+begin_src emacs-lisp
  (use-package elfeed
    :elpaca (elfeed :repo "seblemaguer/elfeed"
		    :branch "fix_emms_bug")
    :tags '("CONNECTED" "RSS")
...
#+begin_src emacs-lisp
  (use-package elfeed-tube
    :elpaca (elfeed-tube :host github :repo "karthink/elfeed-tube" :files (:defaults (:exclude "elfeed-tube-mpv.el")))
    :after elfeed
  ...
  (use-package elfeed-tube-mpv
    :elpaca (elfeed-tube-mpv :host github :repo "karthink/elfeed-tube" :files ("elfeed-tube-mpv.el"))
    :tags '("CONNECTED" "RSS" "YOUTUBE")
...
#+begin_src emacs-lisp
  (use-package mu4e-alert
    :elpaca (mu4e-alert :host github :repo "seblemaguer/mu4e-alert" :branch "mu-1.7")
...
#+begin_src emacs-lisp
  (use-package mu4e-column-faces
    :elpaca (mu4e-column-faces :host github :repo "Alexander-Miller/mu4e-column-faces")
...
#+BEGIN_SRC emacs-lisp
  (use-package oauth2-auto
    :elpaca (oauth2-auto :host github :repo "rhaps0dy/emacs-oauth2-auto"))
...
#+BEGIN_SRC emacs-lisp
  (use-package plz
    :elpaca (plz :host github :repo "alphapapa/plz.el")
...
#+begin_src emacs-lisp
  (use-package slack
    :elpaca (slack :host github :repo "seblemaguer/emacs-slack")
...
#+begin_src emacs-lisp
  (use-package helm-slack
    :elpaca (helm-slack :host github :repo "yuya373/helm-slack")
...
#+BEGIN_SRC emacs-lisp
  (when (executable-find "aria2c")
    (use-package aria2
      :elpaca (aria2 :host github :repo "seblemaguer/aria2")
...
#+begin_src emacs-lisp
  (use-package seriestracker
    :elpaca (seriestracker :host github :repo "MaximeWack/seriesTracker")
...
#+begin_src emacs-lisp :lexical no
  (use-package subed
    :elpaca (subed :host github :repo "sachac/subed" :files ("subed/*.el"))
    :bind (
      :map subed-mode-map (
...
#+begin_src emacs-lisp
  ...
  (when (executable-find "dtach")
    (use-package detached
      ;; NOTE: the original repo is a pain to access with ssh, using the emacsmirror
      :elpaca (detached :host github :repo "emacsmirror/detached")
      :tags '("SYSTEM")
      :init
      (detached-init)
      :bind (
...
#+begin_src emacs-lisp
  (when (executable-find "conda")
    (use-package conda
      ...
      :elpaca (conda :host github :repo "seblemaguer/conda.el")
      :init
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package elcontext
    :elpaca (elcontext :host github :repo "rollacaster/elcontext"
                         :fork (:host github
...
#+begin_src emacs-lisp
  ...
  (use-package scrollkeeper
    :elpaca (scrollkeeper :host github :repo "alphapapa/scrollkeeper.el")
    :tags '("VISUAL")
    :bind (
