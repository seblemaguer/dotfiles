...
#+begin_src emacs-lisp
  (use-package org-analyzer
    ...
    :custom (org-analyzer-org-directory cloud-org-root-dir)
    ...
    (setq org-super-agenda-groups
          '(
            ...
            (:name "Scheduled Today"
                   :and (:scheduled today  :not (:todo "HOLD") :not (:todo "BLOCKED") :not (:todo "RELEASE"))
                   :order 1)
            (:name "Scheduled, past but opened"
                   :and (:scheduled past   :not (:todo "HOLD") :not (:todo "BLOCKED") :not (:todo "RELEASE"))
                   :order 5)
            (:name "Scheduled in the next couple of days"
                   :and (:scheduled future :not (:todo "HOLD") :not (:todo "BLOCKED") :not (:todo "RELEASE"))
                   :order 6)
            )))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package company-box
    :after company
    :tags '("COMPLETION" "UI")
    :elpaca (company-box :repo "seblemaguer/company-box" :type git :host github :branch "functional")
...
The render for now is achieved by calfw and I especially like the package =calfw-blocks= which allows a block-based visualisation.

#+BEGIN_SRC emacs-lisp
  (use-package calfw
    :tags '("CONNECTED" "CALENDAR" "VISUAL"))

  (use-package calfw-org
    :tags '("CONNECTED" "CALENDAR" "VISUAL" "ORG"))
  ...
  (use-package calfw-blocks
    ...
    (defun open-block-calendar ()
      "Open a new buffer with the block calendar using `calfw-blocks'."
      (interactive)
      (cfw:open-calendar-buffer
       :contents-sources (list (cfw:org-create-source "medium purple"))
       :view 'block-week)))

  (use-package org-caldav
    :tags '("CONNECTED" "CALENDAR")
