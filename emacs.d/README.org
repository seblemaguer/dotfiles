    ...
    (setq org-capture-templates
          (doct `(
                  ("Calendar"
                   :keys "c"
                   :type entry
                   :file "/home/lemagues/org/work.org"
                  ...
                  ("Slack"
                   ...
                   :file ,(concat cloud-org-root-dir "todo/todo.org")
                   :headline "To Sort"
                   :template-file ,(format "%s/third_parties/org-capture-templates/slack.org" user-emacs-directory)))))
    )
#+end_src
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-caldav
    ...
    (add-to-list 'org-agenda-default-files (format "%s/calendars/work.org" user-emacs-directory)))
#+END_SRC
...
#+begin_src emacs-lisp
  (use-package slack
    ...
    (slack-message-mention-face ((t (:background unspecified :foreground "SeaGreen" :weight bold))))
