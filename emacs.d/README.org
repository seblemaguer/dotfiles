...
#+begin_src emacs-lisp
  (use-package use-package-tags
    :ensure (use-package-tags :type git :host github :repo "seblemaguer/use-package-tags")
    :config
...
** DONE Some casual helpers
CLOSED: [2024-07-24 Wed 13:50]
[[https://github.com/kickingvegas][Charles Choi]] proposes a nice [[https://github.com/kickingvegas/casual-suite][suite]] based on transient.
I am not using everything so I configure the packages one by one.
The default shortcut for this is "C-o" associated to the given mode!
