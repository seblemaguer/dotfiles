...
#+begin_src emacs-lisp
  ...
  (use-package sauron
    :ensure (sauron :type git :host github :repo "seblemaguer/sauron" :branch "functional")
    :tags '("CORE" "NOTIFICATION")
...
#+begin_src emacs-lisp
  (use-package origami
    :ensure (origami :host github :repo "elp-revive/origami.el")
    :tags '("FOLDING")
    :demand
...
:END:
#+begin_src emacs-lisp
  (defun +elpaca-unload-project (e)
    (and (featurep 'project) (unload-feature 'project t))
    (elpaca--continue-build e))

  ;; You could embed this code directly in the reicpe, I just abstracted it into a function.
  (defun +elpaca-project-build-steps ()
    (append (butlast (if (file-exists-p (expand-file-name "project" elpaca-builds-directory))
                         elpaca--pre-built-steps elpaca-build-steps))
            (list '+elpaca-unload-project 'elpaca--activate-package)))

  (use-package project
    :ensure `(project :build ,(+elpaca-project-build-steps))
...
#+begin_src emacs-lisp
  (use-package cue-mode
    :ensure (cue-mode :repo "seblemaguer/cue-mode" :type git :host github)
...
#+begin_src emacs-lisp
  (use-package colored-authinfo-mode
    :ensure (colored-authinfo-mode :repo "seblemaguer/colored-authinfo-mode" :type git :host github)
    :tags '("PROGRAMMING" "CONFIGURATION")
...
#+begin_src emacs-lisp
  (defun +elpaca-unload-python (e)
    (and (featurep 'python) (unload-feature 'python t))
    (elpaca--continue-build e))

  ;; You could embed this code directly in the reicpe, I just abstracted it into a function.
  (defun +elpaca-python-build-steps ()
    (append (butlast (if (file-exists-p (expand-file-name "python" elpaca-builds-directory))
                         elpaca--pre-built-steps elpaca-build-steps))
            (list '+elpaca-unload-python 'elpaca--activate-package)))


  (use-package python
    :ensure `(python :build ,(+elpaca-python-build-steps))
...
#+begin_src emacs-lisp
  (use-package emacs-overleaf
    :ensure (:type git :host github :repo "seblemaguer/emacs-overleaf")
...
#+begin_src emacs-lisp
  (use-package tikz-mode
    :ensure (tikz-mode :type git :host github :repo "seblemaguer/tikz-mode")
...
#+begin_src emacs-lisp
  (use-package mu4e-alert
    :ensure (:host github :repo "seblemaguer/mu4e-alert" :branch "mu-1.7")
...
#+BEGIN_SRC emacs-lisp
  (use-package org-caldav
    ...
    :ensure (:host github :repo "Thaodan/org-caldav" :branch "thaodan/personal_merger")
    :init
    ...
    (setq org-icalendar-timezone "Europe/Helsinki"
          ...
          org-caldav-calendars `((:calendar-id "lemaguer@ad.helsinki.fi/calendar"
...
#+BEGIN_SRC emacs-lisp
  (use-package ement
    :ensure (ement :host github :repo "seblemaguer/ement.el" :branch "notification")
...
#+begin_src emacs-lisp
  (use-package slack
    :ensure (slack :type git :host github :repo "seblemaguer/emacs-slack")
...
#+BEGIN_SRC emacs-lisp
  (when (executable-find "aria2c")
    (use-package aria2
      :ensure (aria2 :type git :host github :repo "seblemaguer/aria2")
      :tags '("CONNECTED")
...
#+begin_src emacs-lisp
  (use-package emojify
    :ensure nil ;; FIXME: temporary way because of stupid slack enforcement
    :tags '("VISUAL" "DESKTOP")
