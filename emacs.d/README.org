...
#+begin_src emacs-lisp
  (use-package origami
    :elpaca (origami :host github :repo "elp-revive/origami.el")
    :tags '("FOLDING")
    :demand
...
#+begin_src emacs-lisp
  ...
  (use-package project
    :elpaca `(project :build ,(+elpaca-project-build-steps))
...
#+begin_src emacs-lisp
  ...
  (use-package python
    :elpaca `(python :build ,(+elpaca-python-build-steps))
  ...
  (when (display-graphic-p)
    (use-package indicators
      ...
      (defun new-indicators ()
        ...
        ;; show an arrow at the begining of buffer using the default fringe face
        (ind-create-indicator 'point-min
                              :managed t
                              :relative nil
                              :fringe 'right-fringe
                              :bitmap 'left-triangle
                              :face 'fringe)
