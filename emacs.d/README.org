...
#+NAME: ipython-entry-keybindings
| Key    | Functon    | Description |
|--------+------------+-------------|
| C-<f6> | run-python |             |
...
#+begin_src emacs-lisp
  (use-package python
    ...
    :bind (
      <<keybindings-gen(table=ipython-entry-keybindings)>>
    )
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package ement
    ...
    :custom-face
    (ement-room-read-receipt-marker ((t (:box '(:line-width 0.1) :height 0.1 :background "red" :family "Inconsolata-11"))))
    (ement-room-fully-read-marker ((t (:box '(:line-width 0.1) :height 0.1 :background "green" :family "Inconsolata-11"))))
