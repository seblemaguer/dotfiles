...
#+begin_src emacs-lisp
  ...
  (use-builtin ox-html ;; org-contrib
    ...
    (add-to-list 'org-file-apps '("\\.x?html?\\'" . "/usr/bin/ungoogled-chromium %s")))
...
#+begin_src emacs-lisp
  ...
  (use-package eglot
    ...
    (setq native-comp-speed 3
          native-comp-compiler-options '("-march=znver3" "-Ofast" "-g0" "-fno-finite-math-only"
  ...
  (use-builtin bibtex
    ...
    (defun bibtex-tidy-buffer ()
      ...
      (let ((cmd (format "bibtex-tidy %s %s %s --v2 -m %s"
                         ...
                         "--curly --numeric --space=4 --align=13 --no-escape --enclosing-braces=title,journal,publisher,author"
